...
/// pinned to an explicit version (branch/tag). The actual add/remove/modify
/// diff against the base lives in a sibling `overlay.yml` file, not in this
/// struct.
///
...
pub struct SdkConfig {
    ...
    /// explicit version. The add/remove/modify diff lives in a sibling
    /// `overlay.yml` file. See [`ExtendsConfig`] for the accepted forms.
